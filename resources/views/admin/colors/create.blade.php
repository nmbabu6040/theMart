                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="name" id="name" value="{{ old('name') }}"
                                    class="form-control @error('name') is-invalid @enderror" placeholder="Example: Red">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="color" id="color_picker" value="{{ old('code', '#000000') }}"
                                        class="form-control">

                                    <input type="text" name="code" id="code" value="{{ old('code', '#000000') }}"
                                        class="form-control @error('code') is-invalid @enderror" placeholder="#000000">
