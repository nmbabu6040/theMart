            ...
            <li class="nav-item">
                ...
                <div class="collapse" id="uiComponents">
                    <ul class="nav sub-menu">
                        ...
                        <li class="nav-item">
                            <a href="{{ route('colors.index') }}" class="nav-link">Colors</a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('tags.index') }}" class="nav-link">Tags</a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('wishlists.index') }}" class="nav-link">WishList</a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('subscribers.index') }}" class="nav-link">Subscribe</a>
                        </li>
                        <li class="nav-item">
            ...
            <li class="nav-item">
                ...
                <div class="collapse" id="advancedUI">
                    <ul class="nav sub-menu">
                        ...
                        <li class="nav-item">
                            <a href="{{ route('orders.index') }}" class="nav-link">Order management</a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('sliders.index') }}" class="nav-link">Slider</a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('settings.index') }}" class="nav-link">Settings</a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('instagram.index') }}" class="nav-link">Instagram Post</a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('about.edit') }}" class="nav-link">About page</a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('faq.index') }}" class="nav-link">FAQ page</a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('service.index') }}" class="nav-link">Service</a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('gallery.index') }}" class="nav-link">About Gallery</a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('questions.index') }}" class="nav-link">Contact questions</a>
                        </li>
                    </ul>
                </div>
            </li>
