                        ...
                        <form class="tp-accountWrapper" action="#">
                            <div class="tp-accountInfo">
                                <div class="tp-accountInfoHeader">
                                    <a href="{{ asset('frontend/index.html') }}"><img
                                            src="{{ asset('frontend/assets/images/logo-2.svg') }}" alt=""> </a>
                                    <a class="tp-accountBtn" href="{{ asset('frontend/register.html') }}">
                                ...
                                <div class="back-home">
                                    <a class="tp-accountBtn" href="{{ asset('frontend/index.html') }}">
                            ...
                            <div class="tp-accountForm form-style">
                                ...
                                <p class="subText">Don't have an account? <a
                                        href="{{ asset('frontend/register.html') }}">Create free
                                        account</a></p>
                            </div>
                        </form>
                    </div>
